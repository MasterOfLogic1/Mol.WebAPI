...
@extend_schema(
    ...
    description="Retrieves a paginated list of all courses. Public endpoint.",
    tags=["Courses"]
)
@api_view(['GET'])
...
def create_course(request):
    try:
        ...
        if not request.user.is_staff and (not request.user.role or request.user.role.name != 'admin'):
            return Response(
